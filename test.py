...
def main():
    ...
    parser.add_argument("-i3", "--Input3", help = "Provide Input")
    parser.add_argument("-k", "--k", help = "Provide Input")
    ...
    if w2 not in w2v.word_index:
        ...
        exit()
    if w3 not in w2v.word_index:
        print("{} not present in vocabulary".format(w3))
        exit()
    ...
    topSimilar(w2v, pred, k, w1, w2, w3)
